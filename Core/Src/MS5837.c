...
//extern I2C_HandleTypeDef * MS5837_i2c_Port;
//#define i2cHandler hi2c3
I2C_HandleTypeDef * MS5837_i2c_Port;
/****************************READ & WRITE FUNCTIONS*****************************************/

static HAL_StatusTypeDef I2C_Write(uint8_t addr) {
	if(HAL_I2C_Master_Transmit(MS5837_i2c_Port, MS5837_ADDR<<1, &addr, 1, 100) != HAL_OK)
		return MS5837_ERROR;
...
static t_MS5837_Status I2C_Read(uint8_t addr,uint8_t *reg_data, uint8_t r_len){
	...
	if(HAL_I2C_Master_Receive(MS5837_i2c_Port, MS5837_ADDR<<1, reg_data, r_len, 100) == HAL_OK){
		return MS5837_OK;
	}
